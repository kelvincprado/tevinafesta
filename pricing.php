    ...
    <div class="container inner">
      ...
      <div class="row">
        <div class="col-sm-4">
          <div class="pricing panel">
            ...
            <!--/.panel-body -->
            <div class="panel-footer"> <a href="#" class="btn btn-blue" role="button">Choose Plan</a></div>
          </div>
          <!--/.pricing --> 
        </div>
        <!--/column -->
      ...
      <div class="row">
        ...
        <div class="col-sm-6 col-md-3">
          <div class="pricing panel">
            <div class="panel-heading">
              <div class="icon icon-m"><i class="budicon-network"></i></div>
              <h3 class="panel-title">Community <span class="panel-desc">Large Enterprise</span></h3>
              <div class="price"> <span class="price-currency">$</span><span class="price-value">75</span> <span class="price-duration">year</span></div>
            </div>
            <!--/.panel-heading -->
            <div class="panel-body">
              <table class="table">
